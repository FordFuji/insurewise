...
@section('content')
    <button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='{{url('backend/banner_slide/banner_slide_form')}}';" style="margin-bottom: 10px;">Add</button>
			...
			var TableList = $('#data-table').dataTable({
				...
				dom: 'Bfrtip',
					...
					"columns": [
						...
						{"data" : "banner_slide_image_mobile"},
						{"data" : "action"},
					],
				});
