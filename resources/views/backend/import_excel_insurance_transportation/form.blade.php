...
@section('title', 'Import Excel ประกันขนส่ง')

@section('content')
    @error('title')
        <div class="alert alert-danger"></div>
    @enderror
    <form action="{{url('backend/import_excel_insurance_transportation/import_excel_insurance_transportation')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
        @csrf
        {{-- <legend>Image</legend>
...
@endif
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="file" name="import_excel_insurance_transportation" id="import_excel_insurance_transportation" class="form-control" required> Recommend Extentsion .xlsx
                <p><a href="{{ asset('public/backend/import_excel/import_excel_insurance_transportation.xlsx') }}">Example</a></p>
            </div>
        </div>
        <div class="form-group">
	...
	$log = DB::table('log_import_excel')
		->where('log_import_excel_insurance', '=', 'transportation')
...
@section('script_footer')
    ...
    <script>
        $(document).ready(function() {
			...
			$(".sub_menu_import_excel_insurance_transportation").prop('class', 'active');
		});
