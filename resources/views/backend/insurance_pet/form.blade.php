...
@endif
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text1" id="insurance_pet_text1" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text1 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text2" id="insurance_pet_text2" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text2 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text3" id="insurance_pet_text3" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text3 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text4" id="insurance_pet_text4" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text4 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text5" id="insurance_pet_text5" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text5 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text6" id="insurance_pet_text6" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text6 }}@endif" required>
            </div>
            <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="text" name="insurance_pet_text7" id="insurance_pet_text7" class="form-control" value="@if(!empty($row)){{ $row->insurance_pet_text7 }}@endif" required>
            </div>
            <div class="col-md-9">
