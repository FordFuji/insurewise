...
@section('content')
    <button class="btn btn-sm btn-primary m-r-5" type="button" onclick="window.location.href='{{url('backend/level_car/form')}}';" style="margin-bottom: 10px;">Add</button>
        ...
        $(document).ready(function() {
			...
			var TableList = $('#data-table').dataTable({
				...
				dom: 'Bfrtip',
					"ajax": {
						"type": "POST",
						"url": "{{url('backend/level_car/server_processing')}}",
						"data": function (d) {},
						headers: {
