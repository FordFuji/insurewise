...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2023 at 09:17 AM
...
(1, 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'Yes', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', 'No', '0000-00-00 00:00:00', '2023-02-08 16:06:37');
...
(4, 1, 'ฟฟ', '0990943010', 'aa@aaa.com', '123', '2023-05-11 14:06:27');
...
CREATE TABLE `insurance_car` (
  ...
  `insurance_car_price` varchar(255) NOT NULL,
...
INSERT INTO `insurance_company` (`insurance_company_id`, `insurance_company_image`, `insurance_company_logo`, `insurance_company_logo2`, `insurance_company_name`, `insurance_company_datetime_create`, `insurance_company_datetime_update`) VALUES
(1, '202302061038162.png', '202302061038160.png', '202302061038161.png', 'วิริยะประกันภัย', '2023-02-06 10:38:17', '2023-02-06 10:38:15'),
(2, '202302061038482.png', '202302061038470.png', '202302061038481.png', 'กรุงเทพประกันภัย', '2023-02-06 10:38:48', '2023-02-06 10:38:47');
...
(2, 1, '', 'ค่ารักษาจากอุบัติเหตุ', 'ค่ารักษาจากการเจ็บป่วย', 'ค่าวัคซีนป้องกันโรคสัตว์เลี้ยง', 'ค่าฝากเลี้ยงกรณีไปต่างประเทศ', 'บาดเจ็บคนภายนอก', 'ค่าใช้จ่ายจัดพิธีศพสัตว์เลี้ยง', 'ทรัพย์สินบุคคลภายนอกเนื่องมาจากสัตว์', 'ธนชาต', 'อุบัติเหตุ XS', '3,000 บาท/ครั้ง', '-', '-', 'ไม่คุ้มครอง', '-', '20,000 บาท', '20,000 บาท', 1400.00, '2023-02-13 14:49:43', '2023-02-14 14:29:43'),
(3, 3, '', 'ค่ารักษาจากอุบัติเหตุ', 'ค่ารักษาจากการเจ็บป่วย', 'ค่าวัคซีนป้องกันโรคสัตว์เลี้ยง', 'ค่าฝากเลี้ยงกรณีไปต่างประเทศ', 'บาดเจ็บคนภายนอก', 'ค่าใช้จ่ายจัดพิธีศพสัตว์เลี้ยง', 'ทรัพย์สินบุคคลภายนอกเนื่องมาจากสัตว์', 'ธนชาต', 'อุบัติเหตุ XS', '3,000 บาท/ครั้ง', '-', '-', 'ไม่คุ้มครอง', '-', '20,000 บาท', '20,000 บาท', 1400.00, '2023-02-13 14:50:07', '2023-02-14 14:28:49');
...
(1, 1, '', 'ค่ารักษาจากอุบัติเหตุ ', 'ค่ารักษาจากการเจ็บป่วย', 'ค่าวัคซีนป้องกันโรคสัตว์เลี้ยง', 'ค่าฝากเลี้ยงกรณีไปต่างประเทศ', 'บาดเจ็บคนภายนอก', 'ค่าใช้จ่ายจัดพิธีศพสัตว์เลี้ยง', 'ทรัพย์สินบุคคลภายนอกเนื่องมาจากสัตว์', 'ธนชาต', 'อุบัติเหตุ XS', '1400', '3,000 บาท/ครั้ง', '-', '-', 'ไม่คุ้มครอง', '-', '20,000 บาท', '20,000 บาท', '2023-02-06 10:43:31', '2023-02-06 10:43:31'),
(2, 2, '', 'ค่ารักษาจากอุบัติเหตุ', 'ค่ารักษาจากการเจ็บป่วย', 'ค่าวัคซีนป้องกันโรคสัตว์เลี้ยง', 'ค่าฝากเลี้ยงกรณีไปต่างประเทศ', 'บาดเจ็บคนภายนอก', 'ค่าใช้จ่ายจัดพิธีศพสัตว์เลี้ยง', 'ทรัพย์สินบุคคลภายนอกเนื่องมาจากสัตว์', 'ธนชาต', 'อุบัติเหตุ XS', '1400', '3,000 บาท/ครั้ง', '-', '-', 'ไม่คุ้มครอง', '-', '20,000 บาท', '20,000 บาท', '2023-02-14 14:27:06', '2023-02-14 14:27:31');
...
(1, '', 'คุ้มครองค่าเสียหายเบื้องต้น ได้รับเลยไม่รอการพิสูจน์ถูก/ผิด', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต สูญเสียอวัยวะ หรือ ทุพพลภาพถาวรสิ้นเชิง', 'คุ้มครองค่าเสียหายที่เกินกว่าค่าเสียหายเบื้องต้น จะได้รับหลังจากพิสูจน์แล้วว่าไม่ได้เป็นผู้ที่ต้องรับผิดตามกฎหมาย', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต หรือทุพพลภาพถาวรสิ้นเชิง', 'การสูญเสียอวัยวะ', 'ค่าชดเชยรายวัน (จ่ายตามจำนวนวันที่เข้ารักษาตัวในฐานะผู้ป่วยใน)', 'รถเก๋ง', 'กระบะ 4 ประตู', 'ใช้สำหรับรถยนต์ส่วนบุคคลเท่านั้น', 645.00, '30,000 บาท', '35,000 บาท', '80,000 บาท', '500,000 บาท', '200,000 - 500,000 บาท', '200 บาท/วัน (สูงสุดไม่เกิน 20 วัน)', '2023-02-06 10:43:09', '2023-02-06 10:43:09'),
(2, '', 'คุ้มครองค่าเสียหายเบื้องต้น ได้รับเลยไม่รอการพิสูจน์ถูก/ผิด', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต สูญเสียอวัยวะ หรือ ทุพพลภาพถาวรสิ้นเชิง', 'คุ้มครองค่าเสียหายที่เกินกว่าค่าเสียหายเบื้องต้น จะได้รับหลังจากพิสูจน์แล้วว่าไม่ได้เป็นผู้ที่ต้องรับผิดตามกฎหมาย', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต หรือทุพพลภาพถาวรสิ้นเชิง', 'การสูญเสียอวัยวะ', 'ค่าชดเชยรายวัน (จ่ายตามจำนวนวันที่เข้ารักษาตัวในฐานะผู้ป่วยใน)', 'รถเก๋ง', 'กระบะ 4 ประตู', 'ใช้สำหรับรถยนต์ส่วนบุคคลเท่านั้น', 645.00, '30,000 บาท', '35,000 บาท', '80,000 บาท', '500,000 บาท', '200,000 - 500,000 บาท', '200 บาท/วัน (สูงสุดไม่เกิน 20 วัน)', '2023-02-13 14:49:16', '2023-02-13 14:49:16'),
(3, '', 'คุ้มครองค่าเสียหายเบื้องต้น ได้รับเลยไม่รอการพิสูจน์ถูก/ผิด', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต สูญเสียอวัยวะ หรือ ทุพพลภาพถาวรสิ้นเชิง', 'คุ้มครองค่าเสียหายที่เกินกว่าค่าเสียหายเบื้องต้น จะได้รับหลังจากพิสูจน์แล้วว่าไม่ได้เป็นผู้ที่ต้องรับผิดตามกฎหมาย', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต หรือทุพพลภาพถาวรสิ้นเชิง', 'การสูญเสียอวัยวะ', 'ค่าชดเชยรายวัน (จ่ายตามจำนวนวันที่เข้ารักษาตัวในฐานะผู้ป่วยใน)', 'รถเก๋ง', 'กระบะ 4 ประตู', 'ใช้สำหรับรถยนต์ส่วนบุคคลเท่านั้น', 645.00, '30,000 บาท', '35,000 บาท', '80,000 บาท', '500,000 บาท', '200,000 - 500,000 บาท', '200 บาท/วัน (สูงสุดไม่เกิน 20 วัน)', '2023-02-14 13:44:20', '2023-02-14 13:44:20'),
(4, '', 'คุ้มครองค่าเสียหายเบื้องต้น ได้รับเลยไม่รอการพิสูจน์ถูก/ผิด', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต สูญเสียอวัยวะ หรือ ทุพพลภาพถาวรสิ้นเชิง', 'คุ้มครองค่าเสียหายที่เกินกว่าค่าเสียหายเบื้องต้น จะได้รับหลังจากพิสูจน์แล้วว่าไม่ได้เป็นผู้ที่ต้องรับผิดตามกฎหมาย', 'ค่ารักษาพยาบาล (ตามจริง)', 'การเสียชีวิต หรือทุพพลภาพถาวรสิ้นเชิง', 'การสูญเสียอวัยวะ', 'ค่าชดเชยรายวัน (จ่ายตามจำนวนวันที่เข้ารักษาตัวในฐานะผู้ป่วยใน)', 'รถเก๋ง กระบะ', 'กระบะ 4 ประตู', 'ใช้สำหรับรถยนต์ส่วนบุคคลเท่านั้น', 645.00, '30,000 บาท', '35,000 บาท', '80,000 บาท', '500,000 บาท', '200,000 - 500,000 บาท', '200 บาท/วัน (สูงสุดไม่เกิน 20 วัน)', '2023-02-14 13:45:10', '2023-02-14 13:45:10');
...
(1, 'LTR Plan', '2023-02-06 09:48:38', '2023-02-06 09:48:38'),
...
--
ALTER TABLE `accident_faq`
  MODIFY `accident_faq_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `banner_slide`
  MODIFY `banner_slide_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `brand_car`
--
ALTER TABLE `brand_car`
  MODIFY `brand_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `business_faq`
--
ALTER TABLE `business_faq`
  MODIFY `business_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cancer_faq`
--
ALTER TABLE `cancer_faq`
  MODIFY `cancer_faq_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `car_contact_confirm`
  MODIFY `car_contact_confirm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `car_faq`
--
ALTER TABLE `car_faq`
  MODIFY `car_faq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `condo_faq`
  MODIFY `condo_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `confirm_accident`
--
ALTER TABLE `confirm_accident`
  MODIFY `confirm_accident_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `confirm_accident2`
--
ALTER TABLE `confirm_accident2`
  MODIFY `confirm_accident2_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `confirm_cancer`
--
ALTER TABLE `confirm_cancer`
  MODIFY `confirm_cancer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `confirm_transportation`
--
ALTER TABLE `confirm_transportation`
  MODIFY `confirm_transportation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `contact_accident`
--
ALTER TABLE `contact_accident`
  MODIFY `contact_accident_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `contact_business`
--
ALTER TABLE `contact_business`
  MODIFY `contact_business_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `contact_cancer`
--
ALTER TABLE `contact_cancer`
  MODIFY `contact_cancer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `contact_car`
--
ALTER TABLE `contact_car`
  MODIFY `contact_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `contact_condo`
--
ALTER TABLE `contact_condo`
  MODIFY `contact_condo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `contact_condo_detail`
--
ALTER TABLE `contact_condo_detail`
  MODIFY `contact_condo_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `contact_detail_home`
--
ALTER TABLE `contact_detail_home`
  MODIFY `contact_detail_home_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `contact_extended`
--
ALTER TABLE `contact_extended`
  MODIFY `contact_extended_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `contact_home`
--
ALTER TABLE `contact_home`
  MODIFY `contact_home_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `contact_pet`
--
ALTER TABLE `contact_pet`
  MODIFY `contact_pet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `contact_pet_detail`
--
ALTER TABLE `contact_pet_detail`
  MODIFY `contact_pet_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `contact_transportation`
--
ALTER TABLE `contact_transportation`
  MODIFY `contact_transportation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `contact_travel`
--
ALTER TABLE `contact_travel`
  MODIFY `contact_travel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `contact_travel_detail`
--
ALTER TABLE `contact_travel_detail`
  MODIFY `contact_travel_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `damages_first`
  MODIFY `damages_first_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `detail_transportation`
  MODIFY `detail_transportation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `extended_faq`
--
ALTER TABLE `extended_faq`
  MODIFY `extended_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `extended_insurance`
--
ALTER TABLE `extended_insurance`
  MODIFY `extended_insurance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `golf_contact`
--
ALTER TABLE `golf_contact`
  MODIFY `golf_contact_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `golf_faq`
--
ALTER TABLE `golf_faq`
  MODIFY `golf_faq_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `healthy_contact_confirm`
  MODIFY `healthy_contact_confirm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `healthy_faq`
--
ALTER TABLE `healthy_faq`
  MODIFY `healthy_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `home_faq`
--
ALTER TABLE `home_faq`
  MODIFY `home_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `import_excel`
--
ALTER TABLE `import_excel`
  MODIFY `import_excel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `insurance_accident`
--
ALTER TABLE `insurance_accident`
  MODIFY `insurance_accident_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `insurance_business`
--
ALTER TABLE `insurance_business`
  MODIFY `insurance_business_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `insurance_car`
  MODIFY `insurance_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `insurance_condo`
  MODIFY `insurance_condo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `insurance_healthy`
  MODIFY `insurance_healthy_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `insurance_home`
--
ALTER TABLE `insurance_home`
  MODIFY `insurance_home_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `insurance_pet`
  MODIFY `insurance_pet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `insurance_transportation`
  MODIFY `insurance_transportation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `insurance_travel`
--
ALTER TABLE `insurance_travel`
  MODIFY `insurance_travel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `level_car`
  MODIFY `level_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `model_car`
  MODIFY `model_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `pet_faq`
  MODIFY `pet_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `prb`
--
ALTER TABLE `prb`
  MODIFY `prb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `prb_faq`
--
ALTER TABLE `prb_faq`
  MODIFY `prb_faq_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `quotation_car`
  MODIFY `quotation_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `quotation_health`
--
ALTER TABLE `quotation_health`
  MODIFY `quotation_health_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sub_model_car`
--
ALTER TABLE `sub_model_car`
  MODIFY `sub_model_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `transportation_faq`
--
ALTER TABLE `transportation_faq`
  MODIFY `transportation_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `travel_faq`
--
ALTER TABLE `travel_faq`
  MODIFY `travel_faq_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `type_insurance`
--
ALTER TABLE `type_insurance`
  MODIFY `type_insurance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `type_repair`
--
ALTER TABLE `type_repair`
  MODIFY `type_repair_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `year_car`
  MODIFY `year_car_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
